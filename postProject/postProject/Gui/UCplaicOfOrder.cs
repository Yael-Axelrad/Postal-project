...
namespace postProject.Gui
{
    public partial class UCplaicOfOrder : UserControl
    {
        ...
        private void panel3_Paint(object sender, PaintEventArgs e)
        {
            ...
            label10.Text = ctdb.SearchKodCity(keepC.CityC).NameCity;
            brnch = brndb.SearchKod(keepC.BranchC);
            label11.Text = brnch.NameB;
            label12.Text = brnch.StritB;
            label13.Text = Convert.ToInt32(brnch.NumBildingB).ToString();
        }
