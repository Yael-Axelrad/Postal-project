...
namespace postProject.Bll
{
    internal class WorkTime
    {
        ...
        public WorkTime(int branchkodT, int numShiftT, string dayT, DateTime openT, DateTime closseT,bool status)
        {
        ...
        public Branch BreanchOfWorkTime()//פעולה המחזירה שורה של סניף
        {
            return new BranchDB().SearchKod(this.BranchkodT);
        }
    }
}
