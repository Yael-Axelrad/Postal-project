...
namespace postProject.Bll
{
    internal class Clients
    {
        ...
        public City CityOfClient()//פעולה המקבלת שורה של עיר
        {
            return new cityDB().SearchKodCity(this.CityC);
        }
        public Branch BreanchOfClient()//פעולה המקבלת שורה של עיר
        {
            return new BranchDB().SearchKod(this.BranchC);
        }
    }
}
